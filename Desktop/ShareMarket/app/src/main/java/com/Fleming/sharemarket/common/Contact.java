...
public class Contact {
    String strike_price, price_value, change_price_value, bid_value, ask_value, vol_value, op_int_value, time;
    int id;
    ...
    // constructor
//    public Contact(int id, String strike_price, String price_value , String change_price_value, String bid_value,
//                   String ask_value,
