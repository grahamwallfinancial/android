...
import com.Fleming.sharemarket.Activities.GraphActivity;
...
public class graph_adapter extends RecyclerView.Adapter<graph_adapter.ViewHolder> {

    private ArrayList<ChainlistClass> listoperatorlist;
    Context activity;
    String Single_share_name;

    public graph_adapter(Context activity, ArrayList<ChainlistClass> listoperatorlist) {
    ...
    @Override
    public graph_adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.optionchainadapter, parent, false);
        return new graph_adapter.ViewHolder(itemView);
    }
